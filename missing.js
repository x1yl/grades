...
const { googleUsername, googlePassword, missingHomeworkDiscordToken, discordUserId } = config;
...
const processElements = async (page, i, j) => {
  const elementType = i ? 1 : 2;
  // Loop through li elements
  while (true) {
    const elementXPath = `/html/body/c-wiz[1]/div[2]/div/div[7]/div[2]/div[${elementType}]/div/div[2]/ol/li[${i || j}]/div/a/div/div[2]/div/div[1]/p[1]`;
    const elementXPath2 = `/html/body/c-wiz[1]/div[2]/div/div[7]/div[2]/div[${elementType}]/div/div[2]/ol/li[${i || j}]/div/a/div/div[2]/div/div[2]/p`;
    const no = `/html/body/c-wiz[1]/div[2]/div/div[7]/div[2]/div[${elementType}]/div/div[2]/ol/li[${i || j}]/div/a/div/div[2]/div/div[1]/p[2]`;
    ...
    const elementXPath3 = `/html/body/c-wiz[1]/div[2]/div/div[7]/div[2]/div[${elementType}]/div/div[2]/ol/li[${i || j}]/div/a`;
...
// Define custom UA and locale
  ...
  await page.goto("https://classroom.google.com/a/missing/all");
  ...
  await client.login(missingHomeworkDiscordToken);
  ...
  const elementXPathNextWeek = '//*[@id="LAST_WEEK"]';
